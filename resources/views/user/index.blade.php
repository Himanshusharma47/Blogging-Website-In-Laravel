        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <section
                ...
                <div class="relative flex flex-col items-center p-4 sm:max-w-xl">
                    ...
                    <h1 class="mb-8 text-center text-4xl font-bold text-white sm:text-5xl md:mb-12 md:text-6xl">Welcome To
                        BlogByte</h1>

                    <div class="flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center">
                        <a href="{{ route('user.blog') }}"
                            class="inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">Get
                            Started</a>
                    </div>
                </div>
                <!-- text end -->
        ...
        <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div class="mb-8 flex flex-wrap justify-between md:mb-16">
                <div class="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
                    <h1 class="mb-4 text-4xl font-bold text-black sm:text-5xl md:mb-8 md:text-6xl">Find your<br />Blogs Here
                    </h1>

                    <p class="max-w-md leading-relaxed text-gray-500 xl:text-lg">This is a section of some simple filler
                ...
                <div class="mb-12 flex w-full md:mb-16 lg:w-2/3">
                    <div
                        ...
                        <img src="https://images.unsplash.com/photo-1593508512255-86ab42a8e620?auto=format&q=75&fit=crop&w=550&h=550"
                            loading="lazy" alt="Photo by Kaung Htet" class="h-full w-full object-cover object-center" />
                    </div>

                    <div class="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
                        <img src="https://images.unsplash.com/photo-1610465299996-30f240ac2b1c?auto=format&q=75&fit=crop&w=550&h=550"
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12 mb-10">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            ...
            <div class="mb-10 md:mb-16">
                ...
                <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Whether sharing your expertise,
                    breaking news, or whatever’s on your mind, you’re in good company on Blogger. Sign up to discover why
                    millions of people have published their passions here.</p>
            </div>
            <!-- text - end -->
            ...
            <div class="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-2 xl:grid-cols-2 xl:gap-16">
                @foreach ($blogData as $item)
                    ...
                    <div class="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
                        <a href="#"
                            class="group relative block h-100 w-full shrink-0 self-start overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-24 md:w-24 lg:h-40 lg:w-40">
                            <img src="{{ $item->image }}" loading="lazy" alt="Photo by Minh Pham"
