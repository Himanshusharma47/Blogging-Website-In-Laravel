...
@section('category-section')
    ...
    <div class="container mt-4">
        ...
        <!-- Add Post Button -->
        <div class="mb-3">
            <a href="{{ route('admin.addcategory') }}"><button type="submit" class="btn btn-warning" data-bs-toggle="modal"
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('category/' . $category->id) }}"><button type="button"
                                    class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteCategoryModal">Delete</button></a>
                        </td>
                    </tr>
                @endforeach
                <tr>
