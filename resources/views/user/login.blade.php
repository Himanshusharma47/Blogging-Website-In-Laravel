        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <form method="post" action="{{ route('userlogin.data') }}" class="mx-auto max-w-lg rounded-lg border">
            ...
            <div class="flex items-center justify-center bg-gray-100 p-4">
              <p class="text-center text-sm text-gray-500">Don't have an account? <a href="{{ route('user.register') }}" class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Register</a></p>
            </div>
          </form>
        </div>
      </div>
